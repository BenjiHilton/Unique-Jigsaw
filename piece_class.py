class Piece(): #A jigsaw puzzle piece class
    def __init__(self,t,r,b,l): #initilize it with the four values for each edges indentation and empty position
        self.top = t
        self.right = r
        self.bot = b
        self.left = l
        self.position = None    #gets assigned to index in piece array - negative when used 
    ...
    def Sum(self):              #sums its indents and extends - used for ALG 1
